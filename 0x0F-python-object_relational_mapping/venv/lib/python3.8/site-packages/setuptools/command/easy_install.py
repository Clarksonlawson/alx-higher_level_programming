...
""")
    ...
    def run(self, show_deprecation=True):
        if show_deprecation:
            self.announce(
                ...
                "and will be removed in a future version.", log.WARN,
            )
    ...
    if sys.version[:3] in (
            '2.3', '2.4', '2.5') or 'real_prefix' in sys.__dict__:
    ...
    INSTALL_SCHEMES = dict(
        ...
        unix_local=dict(
            install_dir='$base/local/lib/python$py_version_short/%s' %
            sitedir_name,
        ...
        deb_system=dict(
            install_dir='$base/lib/python3/%s' %
            sitedir_name,
            script_dir='$base/bin',
        ),
    )
